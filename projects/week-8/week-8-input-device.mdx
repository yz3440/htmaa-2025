...
description: "Using a microcontroller to read input from a vintage PS/2 numpad: a device that would normally plug directly into an old computer. A bit absurd, but a good exercise in understanding the PS/2 protocol."

shortDescription: "intercepts keystrokes from a vintage PS/2 numpad that would otherwise plug directly into a computer."
