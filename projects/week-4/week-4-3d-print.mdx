...
I waited a few days until Dan swapped out the resin tank to a new one. I printed a few more rods again with the SLA resin printer. It turns out that the support material was too close to the slits, so it required a lot of cleaning. Here's a 10x speeded up time lapse of the cleaning process.
