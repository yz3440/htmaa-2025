...
categories: ["weekly assignment", "final project"]
...
> Please let this diagram count as my design files for this assignment.
...
<Media
  widthPercentage={66}
  src="/project-assets/week-1/kodak-carousel-model-4400.jpg"
